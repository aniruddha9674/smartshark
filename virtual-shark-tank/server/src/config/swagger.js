...
OfferCreate: {
  type: "object",
  required: ["pitchId", "amount", "equityRequested"],
  properties: {
    pitchId: { type: "string", format: "uuid" },
    amount: { type: "number", example: 5000000 },
    equityRequested: { type: "number", example: 8 },
...
OfferCounter: {
  type: "object",
  required: ["amount", "equityRequested"],
  properties: {
    amount: { type: "number", example: 6000000 },
    equityRequested: { type: "number", example: 10 },
    conditions: { type: "object", nullable: true },
    message: { type: "string" },
    expiresInDays: { type: "integer", minimum: 1, maximum: 30, default: 7 },
  },
...
Offer: {
  ...
  properties: {
    ...
    equityRequested: { type: "string", example: "8" },
    valuation: { type: "string", example: "62500000.00" },
    conditions: { type: "object", nullable: true },
